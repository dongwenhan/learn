...
Collection 是一个集合接口，提供集合对象的基本操作方法，java 有很多实现 set，list。

### 6.1 list 和 set

 list 和 set 都继承 Collection

List 特点：元素顺序放入，元素可重复，先放的元素在前面。

set 特点：set 元素无序，元素不可重复。
